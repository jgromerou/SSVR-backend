...
export const updateSalesReturn = catchAsync(async (req: Request, res: Response) => {
    ...
    const updatedReturn = await salesReturnsService.updateSalesReturn(
        Number(id),
