...
export const getStockAdjustment = catchAsync(async (req: Request, res: Response) => {
    ...
    const adjustment = await stockAdjustmentsService.getStockAdjustment(Number(id), req.currentUser.company_id);
    ...
    res.status(200).json({
        status: 'success',
        statusCode: 200,
        message: 'Ajuste de stock obtenido correctamente',
